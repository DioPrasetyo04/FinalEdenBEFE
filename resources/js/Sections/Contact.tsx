...
export function Contact() {
    ...
    const content = {
        ID: {
            ...
            subtitle:
                "Ada pertanyaan? Kami siap membantu Anda. Kirim pesan dan kami akan merespons secepatnya.",
            phone: "Telepon",
            ...
            address: "Alamat",
            addressValue:
                "Jl. Tugu Cibogo No. 123, Jakarta Pusat, DKI Jakarta 10350",
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
                    ...
                    >
                        {contactCards.map((card, index) => (
                            ...
                            >
                                <div
                                    className="flex items-start gap-5 p-6 bg-white dark:bg-[#1E293B] rounded-2xl transition-all duration-300 hover:shadow-lg dark:hover:shadow-[#D4AF37]/10"
                                    style={{
                                        boxShadow:
                            ...
                            {!submitted ? (
                                ...
                                >
                                    <div className="space-y-2">
                                        <label
                                            htmlFor="name"
                                            className="block text-sm font-semibold text-[#111827] dark:text-[#F9FAFB]"
                                        >
                                            {text.formName}
                                        </label>
                                        <motion.div
