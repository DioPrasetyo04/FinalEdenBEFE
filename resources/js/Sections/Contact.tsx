...
export function Contact() {
    ...
    const inputClass = "w-full px-4 py-3.5 bg-[#F9FAFB] dark:bg-[#0F172A] border-2 border-[#E5E7EB] dark:border-[#334155] rounded-xl focus:border-[#C8A45C] dark:focus:border-[#D4AF37] focus:ring-4 focus:ring-[#C8A45C]/10 dark:focus:ring-[#D4AF37]/10 transition-all duration-300 text-[#111827] dark:text-[#F9FAFB] placeholder:text-[#9CA3AF] dark:placeholder:text-[#64748B]";
