    ...
    const faqs: FAQItem[] = [
        {
            ...
            answerID:
                "NEW EDEN menyediakan layanan lengkap kedukaan termasuk paket peti jenazah, mobil jenazah, cargo jenazah, formalin/pengawetan, dokumentasi foto & video, layanan kremasi, tanah makam swasta, pengurusan gali kerangka, dan pengawalan/voordrijver.",
            answerEN:
                "NEW EDEN provides comprehensive funeral services including casket packages, hearse service, cargo service, embalming/preservation, photo & video documentation, cremation service, private burial plots, exhumation arrangements, and escort/voordrijver services.",
        },
        {
            questionID:
            ...
            answerID:
                "Waktu persiapan bervariasi tergantung jenis layanan yang dipilih. Untuk layanan standar, kami dapat mempersiapkan dalam waktu 24 jam. Tim kami siap membantu 24/7 untuk kebutuhan darurat.",
            answerEN:
                "Preparation time varies depending on the selected service. For standard services, we can prepare within 24 hours. Our team is ready to assist 24/7 for emergency needs.",
        },
        {
            questionID: "Apakah NEW EDEN melayani pemakaman untuk semua agama?",
            questionEN: "Does NEW EDEN serve funerals for all religions?",
            answerID:
                "Ya, NEW EDEN melayani pemakaman sesuai dengan kepercayaan dan tradisi keluarga dari berbagai agama. Kami menghormati setiap prosesi keagamaan.",
            answerEN:
                "Yes, NEW EDEN serves funerals according to family beliefs and traditions from various religions. We respect every religious procession.",
        },
        {
            questionID: "Bagaimana cara memesan layanan NEW EDEN?",
            questionEN: "How do I order NEW EDEN services?",
            answerID:
                "Anda dapat menghubungi kami melalui WhatsApp, menelepon langsung, atau mengisi formulir pemesanan di website ini. Tim kami akan segera merespons.",
            answerEN:
        ...
        },
        {
            ...
            answerID:
                "Ya, kami menyediakan berbagai paket pemakaman mulai dari economy hingga premium untuk memenuhi kebutuhan dan budget yang berbeda.",
            answerEN:
                "Yes, we provide various funeral packages from economy to premium to meet different needs and budgets.",
        },
        {
            questionID:
            ...
            answerID:
                "Ya, kami melayani cargo jenazah untuk pengiriman antar kota maupun antar negara. Kami akan mengurus semua dokumen dan koordinasi.",
            answerEN:
                "Yes, we serve deceased cargo for inter-city and international shipments. We will handle all documents and coordination.",
        },
    ];
