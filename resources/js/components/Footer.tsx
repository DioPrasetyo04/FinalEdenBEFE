...
export function Footer() {
    const content = {
        ID: {
            ...
            description:
                "Melayani dengan penuh kasih dan profesionalisme dalam setiap langkah perjalanan terakhir.",
        ...
        EN: {
            ...
            description:
                "Serving with love and professionalism in every step of the final journey.",
