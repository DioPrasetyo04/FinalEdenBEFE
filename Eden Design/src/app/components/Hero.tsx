...
export function Hero({ language, onServiceClick, onContactClick }: HeroProps) {
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileHover={{ 
                scale: 1.05, 
                boxShadow: '0 20px 60px -15px rgba(200, 164, 92, 0.6)',
                y: -2
              }}
      ...
      <div className="absolute bottom-1/4 right-10 w-40 h-40 bg-[#C8A45C]/10 dark:bg-[#D4AF37]/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
    </section>
  );
}
