...
export function Sponsors({ language }: SponsorsProps) {
  ...
  const partners: Partner[] = [
    ...
    },
    {
      ...
      color: '#FFFFFF',
      bgColor: '#7C3AED',
      categoryID: 'Institusi Keagamaan',
      categoryEN: 'Religious Institution',
    },
    {
      id: '3',
      ...
      color: '#FFFFFF',
      bgColor: '#D97706',
      categoryID: 'Layanan Perhotelan',
      categoryEN: 'Hospitality',
    },
    {
      id: '4',
      name: 'Asuransi Mandiri Life',
      initials: 'AM',
      color: '#FFFFFF',
      bgColor: '#2563EB',
      categoryID: 'Asuransi Jiwa',
    ...
    },
    {
      ...
      color: '#FFFFFF',
      bgColor: '#1D4ED8',
      categoryID: 'Layanan Perbankan',
      categoryEN: 'Banking Services',
    },
    {
      id: '6',
    ...
    {
      id: '8',
      name: 'Yayasan Kasih Peduli',
      initials: 'YK',
      color: '#FFFFFF',
      bgColor: '#DB2777',
      categoryID: 'Yayasan Sosial',
      categoryEN: 'Social Foundation',
    },
    {
      id: '9',
      name: 'Perhimpunan Medis',
      initials: 'PM',
      color: '#FFFFFF',
      bgColor: '#0D9488',
      categoryID: 'Asosiasi Medis',
      categoryEN: 'Medical Association',
    },
    {
      id: '10',
      ...
      color: '#FFFFFF',
      bgColor: '#374151',
      categoryID: 'Pemakaman Nasional',
      categoryEN: 'National Cemetery',
    },
    {
      id: '11',
      name: 'Perhimpunan Keluarga',
      initials: 'PK',
      color: '#FFFFFF',
      bgColor: '#4F46E5',
      categoryID: 'Organisasi Keluarga',
      categoryEN: 'Family Organization',
    },
    {
      id: '12',
      ...
      color: '#FFFFFF',
      bgColor: '#E11D48',
      categoryID: 'Komunitas Sosial',
      categoryEN: 'Social Community',
    },
  ];
    ...
    <section id="sponsors" className="py-20 lg:py-28 bg-[#F9FAFB] dark:bg-[#1E293B] relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[#6B7280] dark:text-[#94A3B8] max-w-2xl mx-auto">
            {text.subtitle}
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            {partners.map((partner, index) => (
              <motion.div
                ...
                className={`relative bg-white dark:bg-[#0F172A] rounded-2xl p-4 cursor-pointer transition-all duration-300 ${
                  hoveredCard === partner.id
                    ? 'border-2 border-[#C8A45C] dark:border-[#D4AF37] shadow-xl shadow-[#C8A45C]/10 dark:shadow-[#D4AF37]/10'
                    : 'border-2 border-[#F3F4F6] dark:border-[#1E293B] shadow-md'
                }`}
              >
                {/* Colored Logo Icon */}
                <div
                ...
                >
                  <span
                    ...
                    style={{ color: partner.color, fontSize: partner.initials.length > 2 ? '9px' : '11px' }}
                  >
                    {partner.initials}
                  </span>
                </div>
                ...
                {/* Name & Category */}
                <h3 className="text-sm font-semibold text-[#111827] dark:text-[#F9FAFB] leading-snug mb-1 line-clamp-2">
                  {partner.name}
                </h3>
                <p className="text-xs text-[#6B7280] dark:text-[#94A3B8] leading-tight">
                  {language === 'ID' ? partner.categoryID : partner.categoryEN}
                </p>
                ...
                {hoveredCard === partner.id && (
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="absolute top-3 right-3 w-2 h-2 bg-[#C8A45C] dark:bg-[#D4AF37] rounded-full"
                  />
                )}
              </motion.div>
            ))}
