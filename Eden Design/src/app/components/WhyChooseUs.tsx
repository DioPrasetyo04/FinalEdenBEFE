...
export function WhyChooseUs({ language }: FeatureProps) {
  ...
  const content = {
    ID: {
      ...
      subtitle: 'Komitmen kami adalah memberikan pelayanan terbaik dengan penuh empati',
    },
    EN: {
      title: 'Why Choose Us',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="bg-[#F9FAFB] dark:bg-[#1E293B] rounded-2xl p-8 text-center border-2 border-transparent hover:border-[#C8A45C] dark:hover:border-[#D4AF37] transition-all duration-300"
            >
              <motion.div
