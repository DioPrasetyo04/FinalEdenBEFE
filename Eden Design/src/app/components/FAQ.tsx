...
export function FAQ({ language }: FAQProps) {
  ...
  const faqs: FAQItem[] = [
    ...
    {
      questionID: 'Berapa lama waktu yang dibutuhkan untuk persiapan pemakaman?',
    ...
    {
      questionID: 'Apakah tersedia paket pemakaman dengan harga terjangkau?',
    ...
    {
      questionID: 'Apakah NEW EDEN melayani pengiriman jenazah ke luar kota atau luar negeri?',
      questionEN: 'Does NEW EDEN serve deceased transportation out of town or abroad?',
      answerID:
    ...
    {
      questionID: 'Apa yang membedakan NEW EDEN dengan layanan kedukaan lainnya?',
      questionEN: 'What differentiates NEW EDEN from other funeral services?',
      answerID:
    ...
    {
      questionID: 'Apakah bisa konsultasi terlebih dahulu sebelum memutuskan?',
