...
export function Contact({ language, onWhatsAppClick }: ContactProps) {
  ...
  const content = {
    ID: {
      ...
      phone: 'Telepon',
      phoneValue: '+62 21 3234 5678',
      email: 'Email',
      emailValue: 'info@neweden.sch.id',
      address: 'Alamat',
      addressValue: 'Jl. Tugu Cibogo No. 123, Jakarta Pusat, DKI Jakarta 10350',
      hours: 'Jam Operasional',
      hoursValue: 'Senin - Jumat, 7:00 AM - 3:00 PM',
      ...
      formPhonePlaceholder: '+62 813 3456 7890',
      formSubject: 'Subjek',
      formSubjectPlaceholder: 'Pilih subjek pertanyaan',
      formMessage: 'Pesan',
      ...
      successMessage: 'Terima kasih telah menghubungi kami. Kami akan segera merespons.',
    },
    EN: {
      badge: 'GET IN TOUCH',
      ...
      addressValue: 'Jl. Tugu Cibogo No. 123, Jakarta Pusat, DKI Jakarta 10350',
      hours: 'Office Hours',
      hoursValue: 'Monday - Friday, 7:00 AM - 3:00 PM',
  ...
  const contactCards = [
    {
      icon: MapPin,
      label: text.address,
      value: text.addressValue,
      link: 'https://maps.google.com',
    },
    {
      icon: Phone,
      label: text.phone,
      value: text.phoneValue,
      link: 'tel:+622132345678',
    },
    {
      icon: Mail,
      label: text.email,
      value: text.emailValue,
      link: 'mailto:info@neweden.sch.id',
    },
    {
      icon: Clock,
      label: text.hours,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            {contactCards.map((card, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="flex items-start gap-5 p-6 bg-white dark:bg-[#1E293B] rounded-2xl transition-all duration-300 hover:shadow-lg dark:hover:shadow-[#D4AF37]/10"
                  style={{
                ...
                >
                  <motion.div
                    ...
                    className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-[#C8A45C] to-[#B69449] dark:from-[#D4AF37] dark:to-[#C29F2E] rounded-xl flex items-center justify-center shadow-lg"
                  >
                    <card.icon className="w-6 h-6 text-white" strokeWidth={2} />
                  </motion.div>
                  <div className="flex-1">
                    <h3 className="text-sm font-semibold text-[#6B7280] dark:text-[#94A3B8] uppercase tracking-wider mb-2">
                      {card.label}
                    </h3>
                    {card.link ? (
                      <a
                        ...
                        className="text-[#111827] dark:text-[#F9FAFB] text-base md:text-lg hover:text-[#C8A45C] dark:hover:text-[#D4AF37] transition-colors duration-300"
                      >
                        {card.value}
                      </a>
                    ) : (
                      <p className="text-[#111827] dark:text-[#F9FAFB] text-base md:text-lg">
                        {card.value}
                      </p>
                    )}
                  </div>
          ...
          >
            <div className="bg-white dark:bg-[#1E293B] rounded-3xl p-8 lg:p-10 shadow-xl">
              <h3
                className="text-2xl md:text-3xl text-[#111827] dark:text-[#F9FAFB] mb-8"
                style={{ fontFamily: 'Playfair Display, serif' }}
              >
                {text.formTitle}
              </h3>
              ...
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="name" className="block text-sm font-semibold text-[#111827] dark:text-[#F9FAFB]">
                      {text.formName}
                    </label>
                    <motion.div
                      animate={{
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    {/* Email Field */}
                    <div className="space-y-2">
                      <label htmlFor="email" className="block text-sm font-semibold text-[#111827] dark:text-[#F9FAFB]">
                        {text.formEmail}
                      </label>
                      <motion.div
                        animate={{
                    ...
                    {/* Phone Field */}
                    <div className="space-y-2">
                      <label htmlFor="phone" className="block text-sm font-semibold text-[#111827] dark:text-[#F9FAFB]">
                        {text.formPhone}
                      </label>
                      <motion.div
                        animate={{
                  ...
                  {/* Subject Field */}
                  <div className="space-y-2">
                    <label htmlFor="subject" className="block text-sm font-semibold text-[#111827] dark:text-[#F9FAFB]">
                      {text.formSubject}
                    </label>
                    <motion.div
                      animate={{
                  ...
                  {/* Message Field */}
                  <div className="space-y-2">
                    <label htmlFor="message" className="block text-sm font-semibold text-[#111827] dark:text-[#F9FAFB]">
                      {text.formMessage}
                    </label>
                    <motion.div
                      animate={{
                ...
                >
                  <motion.div
                    ...
                    className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-[#C8A45C] to-[#B69449] dark:from-[#D4AF37] dark:to-[#C29F2E] rounded-full mb-6"
                  >
                    <Check className="w-10 h-10 text-white" strokeWidth={3} />
                  </motion.div>
                  <h3 className="text-2xl font-bold text-[#111827] dark:text-[#F9FAFB] mb-3">
                    {text.successTitle}
                  </h3>
