...
export function Services({ language, onServiceDetailClick }: ServicesProps) {
  ...
  return (
    <section id="services" className="py-24 lg:py-32 bg-gradient-to-b from-white via-[#FAFBFC] to-white dark:from-[#0A0F1E] dark:via-[#0F172A] dark:to-[#0A0F1E]">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              >
                ...
                {/* Hover Shadow */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl" style={{ boxShadow: '0 20px 60px -15px rgba(200, 164, 92, 0.4)' }}></div>
