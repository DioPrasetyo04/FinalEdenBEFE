...
export function ServiceDetail({ isOpen, onClose, language, serviceId, onOrderClick }: ServiceDetailProps) {
        ...
        >
          ...
          >
            ...
            <div className="relative h-64 rounded-t-2xl overflow-hidden">
              <img
                src={service.image}
                alt={language === 'ID' ? service.titleID : service.titleEN}
            ...
            <div className="p-6 md:p-8 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {(language === 'ID' ? service.featuresID : service.featuresEN).map(
